...
const COMMANDS: CommandItem[] = [
  ...
  { id: "dash", title: "Buka Dasbor Utama", category: "Navigasi Cepat", url: "/dashboard", icon: <BookOpen size={16} color="#38BDF8" /> },
  { id: "lead", title: "Podium Papan Peringkat & Ranking", category: "Navigasi Cepat", url: "/leaderboard", icon: <Trophy size={16} color="#F59E0B" /> },
