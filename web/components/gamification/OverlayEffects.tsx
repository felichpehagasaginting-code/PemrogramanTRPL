...
export function OverlayEffects() {
  ...
  // Trigger confetti burst on badge unlock or level up
  useEffect(() => {
          ...
          >
            ...
            >
              ...
              <span className="badge badge-primary" style={{ marginBottom: "var(--space-2)" }}>
                <Trophy size={12} weight="fill" /> BADGE BARU UNLOCKED!
              </span>

              <h3 style={{ fontSize: "1.25rem", color: "var(--text-primary)", fontWeight: 700, margin: "8px 0" }}>
                {badgePopup.badge.name}
              </h3>

              <p style={{ color: "var(--text-secondary)", fontSize: "0.9rem", lineHeight: 1.5, marginBottom: "var(--space-4)" }}>
                {badgePopup.badge.description}
              </p>
          ...
          >
            ...
            >
              ...
              <span className="badge badge-success" style={{ marginBottom: "var(--space-4)" }}>
                <Smiley size={12} weight="fill" /> YAY! SUBMIT BERHASIL
              </span>
              ...
              >
                {/* Fallback to simple styled visual for memes */}
                <div
                  style={{
                    color: "white",
                    padding: "20px",
              ...
              <p style={{ color: "var(--text-secondary)", fontSize: "0.875rem", lineHeight: 1.5 }}>
                Tugas coding selesai dengan sempurna. Kamu berhak mendapatkan meme penyemangat!
              </p>
            </motion.div>
          </div>
        )}
